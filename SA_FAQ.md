<!-- TOC -->
* [Системный аналитик](#-)
* [`REST and SOAP` {#markdown data-toc-label='fsdfsd'}](#rest-and-soap-#markdown-data-toc-labelfsdfsd--)
  * [API](#api)
  * [SOAP](#soap)
  * [REST](#rest)
  * [XML](#xml)
  * [JSON](#json)
* [Контейнеры данных XML/JSON, XSD/JSON Schema](#--xmljson-xsdjson-schema)
  * [XSD/JSON Schema](#xsdjson-schema)
* [Реляционные СУБД](#-)
  * [Масштабируемость](#)
...
* [Нотации моделирования](#-)
  * [UML](#uml)
  * [BPMN](#bpmn)
  * [EPC (процессное моделирование)](#epc----)
...
Контейнеры данных XML/JSON, XSD/JSON Schema
=
...
Частично ответ выше про SOAP/REST. 
## XSD/JSON Schema
...
## [SELECT](https://metanit.com/sql/postgresql/3.2.php)
...
## [DISTINCT](https://metanit.com/sql/postgresql/4.1.php)
Позволяет выбрать уникальные данные по определенным столбцам.

## [ORDER BY](https://metanit.com/sql/postgresql/4.2.php)
Позволяет отсортировать значения по определенному столбцу
* **ASC**
* **DESC**

## [LIMIT и OFFSET](https://metanit.com/sql/postgresql/4.3.php)
...
## [IN](https://metanit.com/sql/postgresql/4.4.php)
...
## [Агрегатные функции](https://metanit.com/sql/postgresql/4.5.php)
...
## [GROUP BY](https://metanit.com/sql/postgresql/4.6.php)
...
## [HAVING](https://metanit.com/sql/postgresql/4.6.php)
...
## [INNER JOIN](https://metanit.com/sql/postgresql/6.2.php)
Перед **JOIN** можно указывать **необязательный** оператор **INNER**. 
**JOIN** без уточнений всегда ***ВНУТРЕННИЙ***.

## [OUTER JOIN](https://metanit.com/sql/postgresql/6.3.php)
...
## [UNION [ALL]](https://metanit.com/sql/postgresql/6.5.php)
